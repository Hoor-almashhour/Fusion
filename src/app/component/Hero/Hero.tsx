...
const Hero = () => {
  return (
    <div className="bg-gray-50 text-primary font-sans">
      <section className="flex flex-col md:flex-row items-center justify-between min-h-[100vh] px-3 md:px-[130px] py-12">
        {/* Image */}
        ...
        <div className="md:w-1/2 w-full text-center md:text-right">
          ...
          <p className="text-lg mb-6 text-gray-800">
            <span className="flex items-center justify-center flex-row-reverse md:justify-start md:flex-row-reverse md:text-2xl text-lg font-bold gap-1">
